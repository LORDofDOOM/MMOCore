...
#define SAY_LAVA_DEATH "Natura, perch? mi hai abbandonato!"
...
#define SAY_UZNAM_SLAY "Far? di te un degno trofeo."
#define SAY_UZNAM_DEATH "Risorger? dalla polvere... Presto..."
