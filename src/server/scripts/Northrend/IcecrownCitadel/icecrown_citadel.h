...
enum Data64
{
    ...
    //Teleport data
    DATA_TELEPORT_LIGHTS_HAMMER,
    DATA_TELEPORT_ORATORY_OF_THE_DAMNED,
    DATA_TELEPORT_RAMPART_OF_SKULLS,
    DATA_TELEPORT_DEATHBRINGERS_RISE,
    DATA_TELEPORT_UPPER_SPIRE,
    DATA_TELEPORT_SINDRAGOSAS_LAIR,
    DATA_TELEPORT_FROZEN_THRONE,
    //Professor Putricide doors
    DATA_PROF_COLLISION_DOOR,
    DATA_PROF_ORANGE_DOOR,
    DATA_PROF_GREEN_DOOR,
...
enum eGameobjects
{
    ...
    SINDRAGOSA_TELEPORT            = 202246,
    LICH_TELEPORT                  = 202223,
    PLAGUE_SIGIL                   = 202182,
    BLOODWING_SIGIL                = 202183,
    FROSTWING_SIGIL                = 202181,
