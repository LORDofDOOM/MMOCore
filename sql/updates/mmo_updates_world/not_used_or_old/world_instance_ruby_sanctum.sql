...
('-1666001','Thank you! I could have not held out for much longer. A terrible thing has happened here.','???????! ??? ??? ? ?? ????? ?? ????????????... ????? ????????? ???????? ???????...','17491','6','0','0','SAY_XERESTRASZA_YELL_2'),
...
('-1666004','We did not stand a chance. As my brethren perished around me, I managed to retreat here and bar the entrance.','???? ???? ???????, ??? ?????? ????? ???? ?? ??????. ? ? ?????????? ????? ? ?????????? ????.','17494','0','0','0','SAY_XERESTRASZA_SAY_3'),
...
('-1666110','The orbiting spheres pulse with dark energy!','?? ??????????? ?????? ?????????? ?????? ???????!','0','3','0','0',''),
('-1666111','Your companions effort force Halion further into the physical realm!','???? ???????? ??????????? ??????? ?????? ? ?????????? ???!','0','3','0','0',''),
('-1666112','Your companions effort force Halion further into the twilight realm!','???? ???????? ??????????? ??????? ?????? ? ???????? ???!','0','3','0','0',''),
...
('-1666115','<need translate>','???????? ? ????? ? ????? ?? ?????, ?????? ??????????????? ????????? ????.','0','3','0','0',''),
...
('-1666403','Burn in the master\'s flame!','?????? ? ???? ???????!','17532','6','0','0','SAY_SAVIANA_SPECIAL_1'),
('-1666404','Saviana Ragefire becomes enraged !','|3-3(%s) ??????? ? ???????????!','0','2','0','0','SAY_SAVIANA_ENRAGE');
