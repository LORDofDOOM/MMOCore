...
-- Original 1
UPDATE command SET security = '2' WHERE name = 'npc addformation';
-- Original 1
UPDATE command SET security = '2' WHERE name = 'npc';
-- Original 1
UPDATE command SET security = '2' WHERE name = 'notify';
-- Original 1
UPDATE command SET security = '2' WHERE name = 'namego';
-- Original 1
...
-- Original 1
UPDATE command SET security = '2' WHERE name = 'learn all_default';
-- Original 1
UPDATE command SET security = '2' WHERE name = 'groupsummon';
-- Original 1
UPDATE command SET security = '2' WHERE name = 'gps';
-- Original 1
UPDATE command SET security = '2' WHERE name = 'goname';
-- Original 1
...
-- Original 1
UPDATE command SET security = '2' WHERE name = 'debug areatriggers';
-- Original 1
...
-- Original 1
UPDATE command SET security = '2' WHERE name = 'account addon';
-- Original 1
...
-- Original 1
UPDATE command SET security = '3' WHERE name = 'modify spell';
-- Original 1
...
-- Original 1
UPDATE command SET security = '3' WHERE name = 'modify honor';
-- Original 1
UPDATE command SET security = '2' WHERE name = 'modify fly';
-- Original 1
UPDATE command SET security = '3' WHERE name = 'modify faction';
-- Original 1
...
-- Original 3
UPDATE command SET security = '2' WHERE name = 'account onlinelist';

-- AntiCheat for GM PlayerChars
-- Original 1
UPDATE command SET security = '1' WHERE name = 'anticheat';
-- Original 2
UPDATE command SET security = '1' WHERE name = 'anticheat delete';
-- Original 2
UPDATE command SET security = '1' WHERE name = 'anticheat global';
-- Original 2
UPDATE command SET security = '1' WHERE name = 'anticheat handle';
-- Original 2
UPDATE command SET security = '1' WHERE name = 'anticheat player';