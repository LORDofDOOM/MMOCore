...
INSERT INTO `command` (`name`, `security`, `help`) VALUES ('dala', 0, 'Syntax: .dala Teleportiert dich nach Dalaran und belebt dich dort wieder, wenn du tot bist (Kann nicht im Kampf, Flug oder auf einem Mount verwendet werden)');
